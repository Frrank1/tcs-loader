...
public class TCLoadCoder extends TCLoadTCSRedshift {

    private static Logger log = Logger.getLogger(TCLoadCoder.class);
     ...
     */
    private List doLoadCoder() throws Exception {
